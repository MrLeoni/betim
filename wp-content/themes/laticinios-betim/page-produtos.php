...
<section class="banner produtos" style="background: url(<?php echo $thumb_url[0]; ?>) no-repeat center 40%">
  <!-- Empty -->
</section>
            ...
            <div class="col-xs-offset-3 col-xs-6 col-sm-offset-0 col-sm-3">
              <ul class="category-menu">
                <?php
                  ...
                  <?php }
                ?>
                <li class="cat-btn" id="show-all">Ver Todos</li>
              </ul>
            </div>
            
            <div class="col-xs-offset-0 col-xs-12 col-sm-9">
              <div class="row">
                <?php
                  // Start Loop of posts
                  ...
                  $cat = get_the_category(); ?>
                    <div class="col-sm-12 product-box museo-300 <?php echo $cat[0]->slug; ?>">
                      <div class="product-wrapper">
                        <?php /* <a class="product-link" href="<?php the_permalink(); ?>" title="<?php esc_html(get_the_title()); ?>"><?php the_post_thumbnail("full"); ?><p>+ informações</p></a> */?>
                        <div class="product-info museo-300">
                          <?php the_title("<h4>", "</h4>");
                          the_excerpt(); ?>
                          <div class="product-link-box">
                            <a class="custom-btn" href="<?php echo esc_html(home_url("/contato")); ?>" title="Orçamento">Informações</a>
